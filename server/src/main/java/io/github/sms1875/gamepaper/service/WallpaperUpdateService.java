...
public class WallpaperUpdateService {
  ...
  private final WallpaperProcessingService wallpaperProcessingService;
  ...
  public WallpaperUpdateService(Map<String, AbstractGameImageRetrievalService> gameImageServices,
      ...
      WallpaperProcessingService wallpaperProcessingService) {
    this.gameImageServices = gameImageServices;
    this.firebaseUploadService = firebaseUploadService;
    this.wallpaperProcessingService = wallpaperProcessingService;
  }
  ...
  public CompletableFuture<Void> updateGameWallpapers(Game game) {
    ...
    return service.getImageUrlsAsync()
        .thenApply(wallpaperProcessingService::processImages)
        .thenCompose(processedImages -> firebaseUploadService.uploadWallpapers(game, processedImages))
